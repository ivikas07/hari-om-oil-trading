  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <Head>
        ...
        <meta
          property="og:title"
          content="Hari Om Oil Tradings | Your Lubricant Trading Partner"
        />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Hari Om Oil Tradings | Trusted Trader of Engine Oils, Greases & Industrial Polymers Across India"
        />
        <meta
